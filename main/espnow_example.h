...
// In the example_espnow_data_t struct, add PCB name field:
// Define max PCB name length first
#define MAX_PCB_NAME_LENGTH 5

// Add this function declaration before the #endif:
...
typedef struct {
  ...
  char pcb_name[MAX_PCB_NAME_LENGTH]; // PCB name for identification
